  ...
  return (
    <div className="p-margin-mobile md:p-margin-desktop max-w-[1600px] mx-auto">
      <div className="flex flex-col md:flex-row justify-between items-start md:items-center mb-8 gap-4">
        <div>
          <h2 className="font-headline-md text-headline-md text-on-surface">Inventory Control</h2>
          <p className="font-body-md text-sm text-secondary mt-1">Manage retail products and backbar supplies</p>
        </div>
          ...
          <table className="w-full text-left border-collapse">
            ...
            <tbody className="font-body-md text-sm divide-y divide-outline/5">
              {loading ? (
                ...
                <tr><td colSpan={7} className="p-4 text-center text-secondary">No products found.</td></tr>
                ...
                <tr key={product.id} className="hover:bg-surface-container-low/50 transition-colors">
                  ...
                  <td className={`p-4 text-center font-bold ${product.stock < 5 ? 'text-error' : ''}`}>{product.stock}</td>
                  <td className="p-4 text-center">
                    {product.stock < 5 ? (
                      <span className="inline-block px-2 py-1 bg-error-container/20 text-error rounded-full text-[10px] font-bold">Low Stock</span>
                    ) : (
